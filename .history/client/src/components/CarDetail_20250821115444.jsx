      ...
      <div className="relative bg-white rounded-lg shadow-2xl max-w-4xl w-full p-6 sm:p-8 animate-scale-in">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-center">
          ...
          <div className="w-full md:w-1/2 space-y-4">
            ...
            {/* Book Now Button */}
            <button className="w-full bg-primary text-white font-semibold py-3 rounded-lg hover:bg-secondary transition-colors duration-300 transform hover:scale-105">
              Book Now
            </button>
          </div>
        </div>
