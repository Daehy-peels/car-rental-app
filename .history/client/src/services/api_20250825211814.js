...
export const fetchAdminDashboardData = async () => {
  try {
    const [
      ...
      fetch(`${API_URL}/total_bookings`),
      fetch(`${API_URL}/most_popular_car`),
      fetch(`${API_URL}/monthly_revenue`),
      fetch(`${API_URL}/car_popularity`),
      fetch(`${API_URL}/revenue_by_car_type`), // New fetch
    ]);
