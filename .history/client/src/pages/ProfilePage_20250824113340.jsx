          ...
          {loadingBookings ? (
            ...
            <div className="space-y-6">
              {bookings.map((booking) => (
                <Link
                  to={`/profile/booking/${booking.booking_id}`}
                  key={booking.booking_id}
                  className="block"
                >
                  <div className="border p-4 rounded-lg flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4 transition-transform transform hover:scale-[1.01] hover:shadow-lg">
                    <img
