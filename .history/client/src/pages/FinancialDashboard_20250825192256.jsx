...
const FinancialDashboard = () => {
  ...
  // Custom colors for the BarChart
    ...
    <div className="p-8 bg-white rounded-lg shadow-lg">
      ...
      <div className="mt-10 grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-gray-50 p-6 rounded-lg shadow-md">
          <h4 className="text-xl font-bold text-gray-800 mb-4">Monthly Revenue</h4>
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={data?.monthlyRevenue} margin={{ top: 5, right: 20, left: 10, bottom: 5 }}>
              ...
              <Line type="monotone" dataKey="monthly_revenue" stroke="#8884d8" strokeWidth={2} activeDot={{ r: 8 }} name="Revenue" />
            </LineChart>
          </ResponsiveContainer>
        </div>

        {/* Car Popularity Bar Chart with Colors */}
        <div className="bg-gray-50 p-6 rounded-lg shadow-md">
          <h4 className="text-xl font-bold text-gray-800 mb-4">Top 5 Most Popular Cars</h4>
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={data?.carPopularity} margin={{ top: 5, right: 20, left: 10, bottom: 5 }}>
              <CartesianGrid strokeDasharray="3 3" />
