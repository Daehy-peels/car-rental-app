...
function App() {
  ...
  const handleLogin = (user) => {
    setCurrentUser(user);
    // You might want to store the user in local storage or session storage
    ...
    <div className="flex flex-col min-h-screen bg-background font-sans antialiased">
      ...
      <div className="flex-grow">
        <Routes>
          <Route
            path="/"
            element={<HomePage onCarSelect={handleCarSelect} />}
          />
          <Route
            path="/cars"
            element={<CarsPage onCarSelect={handleCarSelect} />}
          />
          <Route
            path="/"
            element={
          ...
          />
          <Route
            path="/profile/booking/:bookingId"
