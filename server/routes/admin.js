...
const db = require("../db"); // Use 'db' as per your code
const adminAuth = require("../middleware/auth"); // Import the new middleware
...
router.get("/reports", adminAuth, async (req, res) => {
  try {
    ...
    const bookingsQuery = `SELECT COUNT(*)::numeric AS total_bookings FROM bookings;`;
...
// Protect the new route as well
router.get("/dashboard/revenue_by_car_type", adminAuth, async (req, res) => {
  try {
